...
void Dwrite::RenderText(wstring text, RECT rect, float size, wstring font, Color color, DWRITE_TEXT_ALIGNMENT hAlign, DWRITE_PARAGRAPH_ALIGNMENT vAlign, DWRITE_FONT_WEIGHT weight, DWRITE_FONT_STYLE style, DWRITE_FONT_STRETCH stretch)
{
    ...
    if (findText == NULL)
    {
        ...
        textDesc.format->SetTextAlignment(hAlign);
        textDesc.format->SetParagraphAlignment(vAlign);
